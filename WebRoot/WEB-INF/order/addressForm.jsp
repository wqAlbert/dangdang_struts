...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>	
		...
		<div class="fill_message">
			<p>
				选择地址：
				<s:select list="mapAddress" id="address" listKey="key" listValue="value.fullAddress" headerKey="-1" headerValue="填写新地址">
				</s:select>
			</p>
			<s:form name="ctl00" method="post" action="produceOrder" id="f" theme="simple">
				<s:token></s:token>
				<s:hidden name="address.id" id="addressId"></s:hidden>
					...
					<tr>
						...
						<td>
							...
							<div class="text_left" id="nameValidMsg">
								<p>
									请填写有效的收件人姓名<br/>
									<span id="errName" class="infoError"><s:property value="errors['address.name']"/></span>
								</p>
							</div>
						</td>
					</tr>
